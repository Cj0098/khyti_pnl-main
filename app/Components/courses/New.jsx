          ...
          {sectionsArray.map((sec, i) => (
            <div className="" key={i}>
              ...
              <div
                ...
                className="hidden"
              >
                {Object.keys(sec.lessons).map((less, index) => (
                  <div className="mx-1 my-4 text-gray-600" key={index}>
                    <div className="flex items-center justify-between px-2 py-2 mb-2 text-right bg-white rounded-lg">
                      <button
                        ...
                        onClick={() => {
                          sectionsArray[i]["lessons"].splice(index, 1);
                          setSectionsArray([...sectionsArray]);
                          console.log(sectionsArray);
                        }}
                      >
                      ...
                      {sectionsArray[i]["lessons"][index]["url"] !== "" && (
                        <a
                          href={`https://lezatkhayati.com/storage/${sectionsArray[i]["lessons"][index]["url"]}`}
                          target="_blank"
                      ...
                      {sectionsArray[i]["lessons"][index]["demo"] !== "" && (
                        <a
                          href={`https://lezatkhayati.com/storage/${sectionsArray[i]["lessons"][index]["demo"]}`}
                          target="_blank"
                          className="px-1 text-sm rounded-lg bg-cyan-200"
                        >
                          مشاهده
                    ...
                    <SunEditor
                      className="px-4 "
                      onChange={(content) =>
                        (sectionsArray[i]["lessons"][index]["content"] =
                          content)
                      }
                      setOptions={{
                        height: 380,
